        ...
        <div className="mt-2 flex w-full max-w-[100%] flex-col gap-y-3 xl:mt-0 xl:max-w-[400px]">
          ...
          <Container className="divide-y p-0">
            ...
            <div className="flex items-center gap-x-3 px-6 py-4">
              <Avatar
                src={customer?.employee?.company?.logo_url || undefined}
                fallback={customer?.employee?.company?.name?.charAt(0).toUpperCase() || "C"}
                size="small"
              />
              <Link
                className="text-sm text-pretty text-blue-500 font-medium"
